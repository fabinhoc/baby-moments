...
const form: Ref<ResetPasswordDto> = ref({
  token: null,
  email: null,
  password: null,
...
const startCountdown = () => {
  ...
  let timer = setInterval(() => {
    ...
    notification({
      caption: t('pages.resetPassword.seconds', {
...
<template>
  <q-form ref="myForm" class="q-gutter-y-lg" @submit.prevent="handleSubmit">
    <q-input
      ...
      :label="$t('app.components.formResetPassword.password')"
      lazy-rules
      outlined
      :rules="[
    ...
    <q-input
      ...
      :label="$t('app.components.formResetPassword.passwordConfirmation')"
      lazy-rules
      outlined
      :rules="[
        () =>
    ...
    <q-btn
      type="submit"
      :label="$t('app.components.formResetPassword.save')"
      outline
      rounded
      class="full-width"
      color="primary"
